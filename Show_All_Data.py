...
#python3 Show_All_Data.py > output.txt
...
conn = psycopg2.connect(database="university", user="postgres", password="12345", host="localhost", port="5433")
cur = conn.cursor()
...
try:
    es_data = es.search(index='materials', body={'query': {'match_all': {}}})
    es_data = str(es_data)
